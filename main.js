...
const returnValueMap = myArray.map(function (value, index) {
    return value * index;
});
console.log('myArray.arrayは [1, 2, 3] であるべき。 : ', myArray.array);
console.log('mapの戻り値は [0, 2, 6] であるべき。 : ', returnValueMap);
...
const returnValueFilter = myArray.filter(function (value) {
    return value % 2 === 1;
});
console.log('myArray.arrayは [1, 2, 3] であるべき。 : ', myArray.array);
console.log('filterの戻り値は [1, 3] であるべき。 : ', returnValueFilter);